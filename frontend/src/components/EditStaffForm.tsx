...
const EditStaffForm: React.FC<StaffFormProps> = ({ editStaff, setEditStaff, staff, refreshStaffData }) => {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            name: staff.name,
            code: staff.mobile.slice(0, 3),
            mobile: staff.mobile.slice(3),
            store: staff.store === "Store A" ? "Store A" : "Store B",
            role: staff.role === "Store Admin" ? "Store Admin" : staff.role === "Sales Operator" ? "Sales Operator" : staff.role === "Sales Purchase Operator" ? "Sales Purchase Operator" : "No Role",
        }
    });
    ...
    return (
        <div>
            <Dialog open={editStaff} onOpenChange={setEditStaff}>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='w-6/12'>
                                            ...
                                            <FormControl>
                                                <Input readOnly placeholder="Enter Here" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
